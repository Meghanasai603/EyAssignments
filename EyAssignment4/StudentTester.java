...
public class StudentTester
{
	public static void main(String[]args) {
		...
		student[0].setGrade();
		student[1]=new Student("lata"    ,new Date(100,2,17),new Integer[] {45,72,68});
		student[1].setGrade();
		student[2]=new Student("Meda",new Date(166,4,6),new Integer[] {91,59,97});
		student[2].setGrade();
		student[3]=new Student("Meghana2",new Date(103,4,6),new Integer[] {96,70,87});
		student[3].setGrade();
		student[4]=new Student("Meghana3",new Date(103,4,6),new Integer[] {76,80,87});
		student[4].setGrade();
