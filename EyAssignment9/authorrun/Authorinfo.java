...
import comey.authorservies.AuthorService;
import comey.authorservies.AuthorServiceImpl;

public class Authorinfo {
	 public static void main(String[] args) {
	        // Create a list of authors
	        List<Author> authorList = List.of(
	                new Author(123456789L, "Doe", "John", "Smith", LocalDate.of(1980, 5, 15), "male", "New York", 9876543210L),
	                new Author(987654321L, "Doe", "Jane", "Smith", LocalDate.of(1985, 8, 20), "female", "Los Angeles", 1234567890L),
	                new Author(456789123L, "Johnson", "Michael", "Brown", LocalDate.of(1975, 3, 10), "male", "Chicago", 6543210987L)
	        );
